    ...
    private List<POI> buildBeijingPOIs() {
        return List.of(
                ...
                new POI("BJ003", "鸟巢（国家体育场）", "ATTRACTION", "景点",
                        ...
                        List.of("景点", "奥运", "拍照", "地标"), "images/stores/niaochao.jpg", "2008年奥运会主体育场", 85),
                new POI("BJ004", "大董烤鸭店（三里屯店）", "RESTAURANT", "北京菜",
                        ...
                        List.of("烤鸭", "北京菜", "高端", "排队"), "images/stores/dadong.jpg", "著名烤鸭店，环境优雅", 92),
                ...
                new POI("BJ012", "日料·九扇（三里屯店）", "RESTAURANT", "日本料理",
                        ...
                        List.of("日料", "刺身", "精致", "约会"), "images/stores/jiushan.jpg", "高端日式料理，食材新鲜", 87),
                new POI("BJ013", "火烧云傣家菜（三里屯店）", "RESTAURANT", "云南菜",
                        ...
                        List.of("云南菜", "网红", "排队", "酸辣"), "images/stores/huoshaoyun.jpg", "人气网红云南菜", 86),
                ...
                new POI("BJ017", "CGV影城（三里屯店）", "ENTERTAINMENT", "电影院",
                        ...
                        List.of("电影", "约会", "娱乐"), "images/stores/cgv.jpg", "高品质影城", 80),
                new POI("BJ018", "四季民福烤鸭店", "RESTAURANT", "北京菜",
                        ...
                        List.of("烤鸭", "北京菜", "排队", "老字号"), "images/stores/sijiminfu.jpg", "北京最受欢迎的烤鸭店之一", 93),
                new POI("BJ019", "北海公园", "ATTRACTION", "景点",
                        39.9260, 116.3890, "西城区文津街1号", "西城", "北京",
                        4.5, 10, 0, LocalTime.of(6, 30), LocalTime.of(20, 0), 90,
                        List.of("公园", "划船", "拍照", "历史"), "images/stores/beihai.jpg", "中国现存最古老、最完整的皇家园林", 85),
                new POI("BJ020", "Pageone书店（北京坊店）", "CULTURE", "书店",
                        ...
                        List.of("书店", "文艺", "拍照", "安静"), "images/stores/pageone.jpg", "最美书店之一", 82),
                new POI("BJ021", "火烧云（国贸店）", "RESTAURANT", "云南菜",
                        39.9095, 116.4625, "朝阳区国贸商城B1层", "国贸", "北京",
                        4.5, 130, 30, LocalTime.of(11, 0), LocalTime.of(21, 0), 75,
                        List.of("云南菜", "网红", "酸辣", "下饭"), "images/stores/huoshaoyun2.jpg", "国贸人气云南菜餐厅", 84),
