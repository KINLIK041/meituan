...
const SCENARIOS = {
  '朋友聚会': {
    ...
    intro: '我可以帮你规划适合朋友见面、吃饭、聊天或轻活动的路线。先补充几个关键信息，我会帮你生成更准确的方案。',
    questions: [
      { id: 'time',   label: '你们大概什么时候出发？', options: ['现在', '今天晚上', '周末下午', '自定义'] },
      { id: 'place',  label: '想在哪附近规划？',       options: ['当前位置附近', '地铁站附近', '指定商圈', '输入地点'] },
      { id: 'budget', label: '人均预算大概多少？',     options: ['¥80 以内', '¥150 以内', '¥200 以内', '自定义'] },
  ...
  '情侣约会': {
    ...
    questions: [
      { id: 'time',   label: '什么时候出发？',     options: ['今天晚上', '周末下午', '周末晚上', '自定义'] },
      { id: 'place',  label: '在哪附近规划？',     options: ['当前位置附近', '地铁站附近', '指定商圈', '输入地点'] },
      { id: 'budget', label: '人均预算？',         options: ['¥150 以内', '¥250 以内', '¥400 以内', '不设上限'] },
      { id: 'mood',   label: '更想要的氛围？',     options: ['安静聊天', '出片拍照', '慢节奏散步', '看演出 / 看展'] },
    ],
  },
  '一个人放松': {
  ...
  '亲子遛娃': {
    ...
    questions: [
      { id: 'time',   label: '什么时候出发？',  options: ['现在', '今天下午', '周末上午', '周末下午'] },
      { id: 'place',  label: '在哪附近？',      options: ['当前位置附近', '地铁站附近', '指定商圈', '输入地点'] },
      { id: 'budget', label: '人均预算？',      options: ['¥80 以内', '¥150 以内', '¥250 以内', '自定义'] },
      { id: 'mood',   label: '孩子最爱什么？',  options: ['室内乐园', '互动展览', '户外公园', '美食 + 短玩'] },
    ],
  },
  '下班回血': {
    icon: 'Soup', tintIdx: 1,
    ...
    questions: [
      { id: 'time',   label: '什么时候吃？',     options: ['现在', '半小时后', '一小时后', '自定义'] },
  ...
  '临时救场': {
    ...
    questions: [
      { id: 'time',   label: '多久要到？',    options: ['10 分钟内', '20 分钟内', '30 分钟内', '自定义'] },
